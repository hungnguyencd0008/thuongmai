...
class VpProductsDongho extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        //
       Schema::create('vp_products_dongho', function (Blueprint $table) {
    ...
    {
        //
        Schema::dropIfExists('vp_products_dongho');
    }
}
