...
class VpProductsPhukien extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        //
       Schema::create('vp_products_phukien', function (Blueprint $table) {
    ...
    {
        //
        Schema::dropIfExists('vp_products_phukien');
    }
}
