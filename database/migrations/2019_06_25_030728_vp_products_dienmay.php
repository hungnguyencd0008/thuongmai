...
class VpProductsDienmay extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        //
        Schema::create('vp_products_dienmay', function (Blueprint $table) {
    ...
    {
        //
        Schema::dropIfExists('vp_products_dienmay');
    }
}
