...
class VpProductsLaptop extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        //
        Schema::create('vp_products_laptop', function (Blueprint $table) {
    ...
    {
        //
       Schema::dropIfExists('vp_products_laptop');
   }
}
