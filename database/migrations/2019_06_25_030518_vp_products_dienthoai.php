...
class VpProductsDienthoai extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        //
       Schema::create('vp_products_dienthoai', function (Blueprint $table) {
    ...
    {
        //
        Schema::dropIfExists('vp_products_dienthoai');
    }
}
