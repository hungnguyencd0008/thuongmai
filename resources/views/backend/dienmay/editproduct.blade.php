						...
						<div class="row" style="margin-bottom:40px">
							<div class="col-xs-8">
								...
								<div class="form-group" >
									...
									<img id="avatar" class="thumbnail" width="300px" src="{{asset('../storage/app/diemay/'.$product->prod_img)}}">
								</div>
								<div class="form-group" >
								...
								<a href="{{asset('admin/product/diemay')}}" class="btn btn-danger">Hủy bỏ</a>
							</div>
						</div>
						{{csrf_field()}}
					</form>
